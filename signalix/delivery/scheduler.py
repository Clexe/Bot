...
from signalix.config import ALL_PAIRS, CRYPTO_PAIRS, FOREX_PAIRS
from signalix.strategy.precision_pipeline import run_precision_pipeline
from signalix.strategy.flow_pipeline import run_flow_pipeline
from signalix.signals.generator import generate_signal
from signalix.ai.deepseek_client import generate_precision_rationale, generate_flow_rationale
...
async def _fetch_candles(pair: str, deriv_client, bybit_client) -> dict:
    ...
    try:
        if pair in CRYPTO_PAIRS:
            ...
            from signalix.config import TF_MAP_DERIV
