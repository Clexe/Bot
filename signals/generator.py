...
async def generate_signal(pair: str, direction: str, trade_levels: dict, context: dict):
    ...
    hard_gates = [context['storyline_established'], context['poi_fresh'], context['idm_swept'], in_kz and kz_name in {'London','New York','New York PM'}, context['ltf_shift_confirmed']]
